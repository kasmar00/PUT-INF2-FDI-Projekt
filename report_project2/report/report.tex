...
\end{enumerate}
\section{Wykaz przesłanych plików zawartych w \verb+Source\_2\_145380.zip}
    \begin{enumerate}
        ...
        \item Katalog \verb+report+ zawierający:
        \begin{itemize}
            \item Plik źródłowy sprawozdania w formacie \LaTeX: \verb+report.tex+
            \item Zrzuty ekranu wykorzystane w sprawozdaniu: \verb+pomiaryX.png+
        \end{itemize}
